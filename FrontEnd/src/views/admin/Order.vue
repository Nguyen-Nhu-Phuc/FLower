    ...
    <div class="bodys">
      ...
      <div :style="{ maxWidth: '1200px', overflow: 'scroll' }">
        <table class="table" :style="{ maxWidth: '1000px', overflowX: 'auto' }">
          ...
          >
            <tr>
              <th class="tab" :style="{ minWidth: '10px' }">TT</th>
              <th class="tab" :style="{ minWidth: '80px' }">Người Dùng</th>
              <th class="tab" :style="{ minWidth: '90px' }">Ảnh</th>
              <th class="tab" :style="{ minWidth: '120px' }">Tên Sản Phẩm</th>
              <th class="tab" :style="{ minWidth: '60px' }">Số Lượng</th>
              <th class="tab" :style="{ minWidth: '90px' }">Giá</th>
              <th class="tab" :style="{ minWidth: '100px' }">Tổng Tiền</th>
              <th class="tab" :style="{ minWidth: '100px' }">Thời Gian Order</th>
              <th class="tab" :style="{ minWidth: '170px' }">Địa chỉ chi tiết</th>
              <th class="tab" :style="{ minWidth: '150px' }">Trạng Thái</th>
              <th class="tab" :style="{ minWidth: '150px' }">Thao Tác</th>
            </tr>
          </thead>
