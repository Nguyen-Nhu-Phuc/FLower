                                    ...
                                    <td>
                                        <ul class="action-list">
                                            <li><button type="button" class="btn1 btn-primary" data-toggle="modal"
                                                    ...
                                                    @click="getOneProduct(item._id)"><i
                                                        class="fa fa-pencil-alt"></i></button>
                                            </li>
                                            <li><button class="btn2 btn-i btn-danger" @click="copyID(item._id)"
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-sm-7">
                                                        ...
                                                        <div class="input-group expiration-date ">
                                                            <select disabled class="form-control select-TH" name=""
                                                                id="add" v-model="this.product.address" required="true">
                                                    ...
                                                    <div class="form-group col-sm-5">
                                                        ...
                                                        <div class="input-group expiration-date">
                                                            <input type="number" class="form-control" placeholder="VNĐ"
                                                                id="prices" v-model="this.product.priceR"
                                                                required="true">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm-5">
                                        ...
                                        this.product.discount) }}
                                                    ...
                                                    <div class="form-group col-sm-8">
                                                        ...
                                                        <div v-if="this.product.image.url != undefined">
                                                            <img class="img-product" :src="this.product.image.url"
                                                                alt="">
                                                        </div>
